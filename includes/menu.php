 <div class="menu">
    <div class="navbar">
        ...
        <div class="nav-collapse collapse">
          ...
          ?>
              <li class="<?php if($currenttitle=='index') echo 'active';?> border-left"><a href="http://exam.jsblogs.in/">Home</a></li>
                <?php
        ...
        ?>      
               ...
               <!-- <li class="<?php if($currenttitle=='howitworks') echo 'active';?>"><a href="howitworks.php">How It Works</a></li> -->
                ...
                <li class="<?php if($currenttitle=='User Login') echo 'active';?>"><a href="login.php">User Login</a></li>
                <li class="<?php if($currenttitle=='User Register') echo 'active';?>"><a href="register_one.php">User Register</a></li>
            </ul>
        </div><!--/.nav-collapse -->
    </div>
            <div class="mini-menu">
