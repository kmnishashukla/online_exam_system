...
if(isset($_POST['submit'])){
	...
	$email = $_GET['email'];
	$changepass = mysqli_query($connect,"update adminregistration set password='".$password."' where email='".$email."'");
    if($changepass){
		...
		echo "<script>
             alert('password created successfully');
              window.location.href='login_twice.php';
             </script>";
        ...
        <div class="container">	
			...
			<section class="main">
				<form class="form-1"  method="POST">
					<p class="field">
						<input type="password" name="password" placeholder="enter your new password" required="1">
