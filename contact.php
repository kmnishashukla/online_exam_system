 ...
 <div class="main-content">
  <div class="featured-content">
     ...
     <div class="span8 offset3">
       <h2 style="margin-bottom: 20px;">Contact With online exam system</h2>
  <?php
...
if(isset($_POST['submit'])){
	...
	//$email = $_GET['email'];
	$changepass = mysqli_query($connect,"insert into contact
  ...
  ?>
         <form action="" method="POST">
          ...
          <button type="submit" class="btn btn-info esb1" name="submit">Send Message</button>
      </form>
       <?php 
       /*  if(isset($msg)){
         echo $msg;
